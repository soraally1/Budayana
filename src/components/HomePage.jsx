    ...
    <div className="relative min-h-screen bg-[#EBE3D5]">
      ...
      <div className="relative h-[400px] sm:h-[500px] ipad-mini:h-[550px] ipad-air:h-[580px] lg:h-[600px]">
        ...
        <div className="relative z-10 h-full flex flex-col lg:flex-row items-center justify-between p-4 sm:p-8 ipad-mini:p-12 ipad-air:p-14 lg:p-16">
          {/* Left Side - Character */}
          <div className="w-[280px] sm:w-[400px] ipad-mini:w-[420px] ipad-air:w-[480px] lg:w-[580px] 
                         -mt-8 sm:mt-0">
            <img 
              src={BannerHero} 
              alt="Character" 
          ...
          <div className="flex flex-col items-center lg:items-end 
            ...
            <img 
              ...
              className="w-full h-auto"
            />
            <p className="font-fuzzy text-white text-base sm:text-lg ipad-mini:text-xl
                         font-bold text-stroke-thick text-center lg:text-right">
              Temukan event budaya 
              kamu, Di Budayana!
            </p>
            <button className="font-fuzzy bg-brown-800 text-white 
                             px-6 sm:px-8 
                             py-2 sm:py-2.5 
      ...
      <div className="relative w-full px-4 sm:px-6 md:px-8 lg:px-16 mt-16 sm:mt-20 md:mt-24">
        <div className="max-w-[1400px] mx-auto">
              ...
              >
                ...
                <div className="absolute top-3 sm:top-4 right-3 sm:right-4">
                  <div className="bg-[#4A3427] rounded-full px-2 sm:px-3 py-1">
                    <span className="text-white text-xs sm:text-sm font-fuzzy">Cek Event!</span>
                  </div>
                </div>
              </motion.div>
              <motion.div 
          ...
          >
            Di Indonesia, ada ratusan event budaya<br className="hidden xs:block"/> 
